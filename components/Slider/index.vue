<template>
  <div class="menu-demo">
    <a-menu :showCollapseButton="false" :auto-open-selected="true" :default-selected-keys="defaultSelectedKeys"
      ...
      <a-sub-menu class="item">
        ...
        <a-menu-item key="/data/live" @click="navigateHandler($event, '/data/live')">{{ $t("app.slider.live")
          }}</a-menu-item>
        <a-menu-item key="/data/content" @click="navigateHandler($event, '/data/content')">{{ $t("app.slider.content")
          }}</a-menu-item>
        <a-menu-item key="/data/multiple" @click="navigateHandler($event, '/data/multiple')">{{
      $t("app.slider.multiple") }}</a-menu-item>
      </a-sub-menu>

      <a-sub-menu class="item">
        <template #icon><icon-bulb></icon-bulb></template>
        <template #title>{{ $t("app.slider.orderManagement") }}</template>
        <a-menu-item key="/order/list" @click="navigateHandler($event, '/order/list')">{{ $t("app.slider.fullOrder")
          }}</a-menu-item>
        <a-menu-item key="/order/edit" @click="navigateHandler($event, '/order/edit')">{{ $t("app.slider.orderStatus")
          }}</a-menu-item>
      </a-sub-menu>
      ...
      <a-sub-menu class="item">
        ...
        <a-menu-item key="/spu/list" @click="navigateHandler($event, '/spu/list')">{{ $t("app.slider.availableGoods")
          }}</a-menu-item>
        <a-menu-item key="/spu/edit" @click="navigateHandler($event, '/spu/edit')">{{ $t("app.slider.modifyGoods")
          }}</a-menu-item>
      ...
      <a-sub-menu class="item">
        ...
        <a-menu-item key="/user/list" @click="navigateHandler($event, '/user/list')">{{ $t("app.slider.existingUsers")
          }}</a-menu-item>
        <a-menu-item key="/user/createuser" @click="navigateHandler($event, '/user/createuser')">{{
      $t("app.slider.createUser") }}</a-menu-item>
        <a-menu-item key="/user/auth" @click="navigateHandler($event, '/user/auth')">{{
      $t("app.slider.authorityManagement") }}</a-menu-item>
      </a-sub-menu>
      ...
      <a-menu-item key="/like" class="item singleMenu" @click="navigateHandler($event, '/like')">
