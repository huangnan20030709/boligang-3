<template>
  <div class="list">
    <div
      ...
      @click="
        () => {
          Message.info({ content: '页面开发中...' });
        }
      ">
      <svg height="47.7" viewBox="0 0 319 477" width="31.9" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <linearGradient id="a">
...
const setList = ["权限分配", "新建账号", "修改账号", "账号问题", "用户问题", "常见问题？"];
</script>
...
.list {
  ...
  width: 100%;
  & .item:nth-child(1) {
    background: linear-gradient(90deg, rgb(46, 167, 254), rgb(20, 157, 254));
  }
  & .item:nth-child(2) {
    background: linear-gradient(90deg, rgb(255, 144, 124), rgb(255, 91, 61));
  }
  & .item:nth-child(3) {
    background: linear-gradient(90deg, rgb(115, 110, 255), rgb(95, 90, 255));
  }
  & .item:nth-child(4) {
    background: linear-gradient(90deg, rgb(240, 100, 177), rgb(237, 76, 157));
  }
  & .item:nth-child(5) {
    background: linear-gradient(90deg, rgb(27, 250, 125), rgb(0, 107, 142));
  }
  & .item:nth-child(6) {
    background: linear-gradient(90deg, rgb(250, 192, 125), rgb(240, 176, 31));
  }
  .item {
    border-radius: 10px;
    height: 120px;
